      ...
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          ...
          <p className="lead text-muted">
            Do you want a faster way to communicate with friends, instead of
            short tweets and impersonal &ldquo;shared&rdquo; posts that are
            reminiscent of the late 90&rsquo;s email forwards? We believe
